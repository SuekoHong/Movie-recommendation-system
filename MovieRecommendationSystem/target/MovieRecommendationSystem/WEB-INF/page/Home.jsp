...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/Homediscovery.css" rel="stylesheet">
...
<nav class="navbar navbar-default" role="navigation" style="background-color: #222;margin-bottom: 0%">
    ...
    <a class="navbar-brand" href="${pageContext.request.contextPath}/index" style="color: white">选电影</a>
    <!-- 判断用户是否登录-->
    <c:if test="${sessionScope.user == null}">
        <a  class="dream" href="${pageContext.request.contextPath}/page/register" id="register" style=" text-decoration:none;float: right;color: white;font-size: 13pt;margin-top: 12px;margin-right: 10px"><span style="color: white" class="glyphicon glyphicon-user"></span> 注册</a>
        <a  class="dream" href="${pageContext.request.contextPath}/page/login" style=" text-decoration:none;float: right;color: white;font-size: 13pt;margin-top: 12px;margin-right: 10px"><span style="color: white" class="glyphicon glyphicon-log-in"></span> 登录</a>
    </c:if>
    <c:if test="${sessionScope.user != null}">
...
<script>
    ...
    $('#pre').click(function(){
        ...
        if(m[movieid]==0)
        {
            ...
            $("a[name='movieaverating']").text("总分:${sessionScope.TopDefaultMovie[4].averating}");
            $("p[name='moviedescription']").text("${sessionScope.TopDefaultMovie[4].description}");
            $("p[name='moviedirector']").text("导演:${sessionScope.TopDefaultMovie[4].director}");
            $("p[name='movietype']").text("类型:${sessionScope.TopDefaultMovie[4].typelist}");
        ...
        if(m[movieid]==1)
        {
            ...
            $("a[name='movieaverating']").text("总分:${sessionScope.TopDefaultMovie[0].averating}");
            $("p[name='moviedescription']").text("${sessionScope.TopDefaultMovie[0].description}");
            $("p[name='moviedirector']").text("导演: ${sessionScope.TopDefaultMovie[0].director}");
            $("p[name='movietype']").text("类型:${sessionScope.TopDefaultMovie[0].typelist}");
        }
        if(m[movieid]==2)
        {
            ...
            $("a[name='movieaverating']").text("总分:${sessionScope.TopDefaultMovie[1].averating}");
            $("p[name='moviedescription']").text("${sessionScope.TopDefaultMovie[1].description}");
            $("p[name='moviedirector']").text("导演: ${sessionScope.TopDefaultMovie[1].director}");
            $("p[name='movietype']").text("类型:${sessionScope.TopDefaultMovie[1].typelist}");
        }
        if(m[movieid]==3)
        {
        ...
        if(m[movieid]==4)
        {
            ...
            $("a[name='movieaverating']").text("总分:${sessionScope.TopDefaultMovie[3].averating}");
            $("p[name='moviedescription']").text("${sessionScope.TopDefaultMovie[3].description}");
            $("p[name='moviedirector']").text("导演: ${sessionScope.TopDefaultMovie[3].director}");
            $("p[name='movietype']").text("类型:${sessionScope.TopDefaultMovie[3].typelist}");
        }
    ...
    $('#next').click(function(){
        ...
        if(m[movieid]==1)
        {
            ...
            $("a[name='movienametag']").text("${sessionScope.TopDefaultMovie[2].moviename}");
            $("a[name='movieaverating']").attr("value","${sessionScope.TopDefaultMovie[2].movieid}");
            $("a[name='movieaverating']").text("总分:${sessionScope.TopDefaultMovie[2].averating}");
            $("p[name='moviedescription']").text("${sessionScope.TopDefaultMovie[2].description}");
            $("p[name='moviedirector']").text("导演： ${sessionScope.TopDefaultMovie[2].director}");
            $("p[name='movietype']").text("类型:${sessionScope.TopDefaultMovie[2].typelist}");
        }
        if(m[movieid]==2)
        {
            var url="${sessionScope.TopDefaultMovie[3].backpost}";
