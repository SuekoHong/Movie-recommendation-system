...
<head>
    ...
    <link data-react-helmet="true" rel="prefetch" href="${pageContext.request.contextPath}/assets/img/user_cover_image.jpg"/>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/douban.main.css" rel="stylesheet"/>
    ...
    <div data-reactid="5">
        ...
        <nav class="navbar navbar-default" role="navigation" style="background-color: black;margin-bottom: 0%">
            ...
            <c:if test="${sessionScope.user == null}">
                <a class="dream" href="${ pageContext.request.contextPath }/page/register" id="register"
                ...
                <a class="dream" href="${ pageContext.request.contextPath }/page/login"
                   style="float: right;color: white;font-size: 13pt;margin-top: 10px;margin-right: 10px"><span
                        ...
                        <div class="UserCoverEditor" data-reactid="64">
                            ...
                            <div data-reactid="65">
                                <div class="UserCover" data-reactid="71">
                                    <!-- 背景图片 -->
                                    <div class="VagueImage UserCover-image" data-src="${pageContext.request.contextPath}/assets/img/user_cover_image.jpg"
                                         data-reactid="72">
                                        <img src="${pageContext.request.contextPath}/assets/img/user_cover_image.jpg">
                            ...
                            <div class="UserAvatarEditor ProfileHeader-avatar" style="top:-57px;margin-left: 20px;"
                                ...
                                <div class="UserAvatar" data-reactid="78">
                                    <img class="Avatar Avatar--large UserAvatar-inner" width="160" height="160"
                                         src="${pageContext.request.contextPath}/assets/img/user_avatar.jpg" srcset="${pageContext.request.contextPath}/assets/img/user_avatar.jpg 2x"
                                         data-reactid="79"/>
                                </div>
                            </div>
