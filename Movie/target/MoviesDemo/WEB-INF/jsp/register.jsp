...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/regandlogcommon.css">
...
<div class="page-container">
    ...
    <form id="regForm_mod">
        ...
        <div id ="d5">
            ...
            <span  style="color: white" class="glyphicon glyphicon-earphone"></span>
            <input type="text" name="usertel"  id="regTel" placeholder="手 机 号" required="required" />
            <span style="color: red"  class="usertelerror"></span>
        </div>
        <%--邮箱--%>
        <div  id="d2">
...
<script type="text/javascript">
    ...
    $("#regTel").focus(function () {
        $("#regTel").removeClass("errorC");
        $("#regTel").removeClass("checkedN");
        $(".usertelerror").show();
        $(".usertelerror").text("  ");
    ...
    $("#regName").blur(function () {
        ...
        $("#regTel").blur(function () {
            if ($("#regTel").val() == "") {
                $("#regTel").addClass("errorC");
                $(".usertelerror").html("<span>▲用户名不能为空</span>");
                $(".usertelerror").show();


            }
            else if($("#regName").val().length!=11){
                $(".usertelerror").show();
                $(".usertelerror").html("<span>▲请输入11位长度手机号</span>").show();
                $("#regTel").addClass("errorC");
            }
            else{
                $("#regTel").addClass("checkedN");
                $(".usertelerror").show();
                $(".usertelerror").text("");
            }
            //判断用户名是否被占用
...
<script type="text/javascript">
    ...
    var arr = new Array();
    arr[0] = "${pageContext.request.contextPath}/assets/img/loginimg/1.jpg";
    arr[1] = "${pageContext.request.contextPath}/assets/img/loginimg/2.jpg";
    arr[2] = "${pageContext.request.contextPath}/assets/img/loginimg/3.jpg";
